-- FUNCTION: migration.loop_estbid_worker_bulk_qualifications(integer)

-- DROP FUNCTION migration.loop_estbid_worker_bulk_qualifications(integer);

CREATE OR REPLACE FUNCTION migration.loop_estbid_worker_bulk_qualifications(
...
ALTER FUNCTION migration.loop_estbid_worker_bulk_qualifications(integer)
    OWNER TO postgres;
