...
BEGIN
  ...
  INSERT INTO cqc."WorkerQualifications" (
	...
	SELECT
		...
		worker_qualification.notes AS target_qualification_notes,
	...
	FROM worker_qualification
		INNER JOIN qualification_level
			INNER JOIN qualification
				INNER JOIN migration.qualificationcategories ON qualificationcategories.tribalid = qualification.id
	...
	ORDER BY worker_qualification.date_qualification) AllQualificationRecords;
END;
$$ LANGUAGE plpgsql;