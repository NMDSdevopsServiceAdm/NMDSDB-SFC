...
ALTER TABLE cqc."Establishment" ALTER COLUMN "DataPermissions" TYPE cqc.establishment_data_access_permission USING "DataPermissions"::cqc.establishment_data_access_permission;
