...
BEGIN
	...
	RETURN QUERY SELECT
		...
		count(LAWorkers."EmploymentStatus") FILTER (WHERE LAWorkers."EmploymentStatus" <> 'Agency') AS  "CountOfIndividualStaffRecordsNotAgencyComplete",
		1.11::DECIMAL(4,1),
		count(LAWorkers."EmploymentStatus") FILTER (WHERE LAWorkers."EmploymentStatus" = 'Agency') AS  "CountOfIndividualStaffRecordsAgency",
		count(LAWorkers."EmploymentStatus") FILTER (WHERE LAWorkers."EmploymentStatus" = 'Agency') AS  "CountOfIndividualStaffRecordsAgencyComplete",
		2.22::DECIMAL(4,1),
